...
static int prm_ha_server_state_default = ha_operations::SERVER_STATE_IDLE;
static int prm_ha_server_state_upper = ha_operations::SERVER_STATE_DEAD;
static int prm_ha_server_state_lower = ha_operations::SERVER_STATE_IDLE;
