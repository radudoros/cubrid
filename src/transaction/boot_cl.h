...
extern int boot_shutdown_client (bool is_er_final, BOOT_CLIENT_TERMINATION_MODE termination_mode);
...
/* *INDENT-OFF* */
extern ha_operations::SERVER_STATE boot_get_ha_server_state (void);
/* *INDENT-ON* */
